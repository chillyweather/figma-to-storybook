...
`;
  ...
  var accessToken, owner, repo, filePath, newCode;
  ...
  function P(n2, l3, u3, i3, t3, o3, r3, f3, e3, a3) {
    var h2, p2, y2, _, b3, m3, w3, x2 = i3 && i3.__k || s, P2 = x2.length;
    for (u3.__k = [], h2 = 0; h2 < l3.length; h2++)
      if (null != (_ = u3.__k[h2] = null == (_ = l3[h2]) || "boolean" == typeof _ || "function" == typeof _ ? null : "string" == typeof _ || "number" == typeof _ || "bigint" == typeof _ ? d(null, _, null, null, _) : v(_) ? d(k, { children: _ }, null, null, null) : _.__b > 0 ? d(_.type, _.props, _.key, _.ref ? _.ref : null, _.__v) : _)) {
        if (_.__ = u3, _.__b = u3.__b + 1, null === (y2 = x2[h2]) || y2 && _.key == y2.key && _.type === y2.type)
          x2[h2] = void 0;
        else
          for (p2 = 0; p2 < P2; p2++) {
        ...
        L(n2, _, y2 = y2 || c, t3, o3, r3, f3, e3, a3), b3 = _.__e, (p2 = _.ref) && y2.ref != p2 && (w3 || (w3 = []), y2.ref && w3.push(y2.ref, null, _), w3.push(p2, _.__c || b3, _)), null != b3 ? (null == m3 && (m3 = b3), "function" == typeof _.type && _.__k === y2.__k ? _.__d = e3 = C(_, e3, n2) : e3 = $(n2, _, y2, x2, b3, e3), "function" == typeof u3.type && (u3.__d = e3)) : e3 && y2.__e == e3 && e3.parentNode != n2 && (e3 = g(y2));
      }
    for (u3.__e = m3, h2 = P2; h2--; )
      null != x2[h2] && ("function" == typeof u3.type && null != x2[h2].__e && x2[h2].__e == u3.__d && (u3.__d = A(i3).nextSibling), q(x2[h2], x2[h2]));
    if (w3)
  ...
  function L(n2, u3, i3, t3, o3, r3, f3, e3, c3) {
    var s2, a3, p2, y2, d3, _, g3, m3, w3, x2, C2, S, $2, A2, H2, I2 = u3.type;
        ...
        if ("function" == typeof I2) {
          if (m3 = u3.props, w3 = (s2 = I2.contextType) && t3[s2.__c], x2 = s2 ? w3 ? w3.props.value : s2.__ : t3, i3.__c ? g3 = (a3 = u3.__c = i3.__c).__ = a3.__E : ("prototype" in I2 && I2.prototype.render ? u3.__c = a3 = new I2(m3, x2) : (u3.__c = a3 = new b(m3, x2), a3.constructor = I2, a3.render = B), w3 && w3.sub(a3), a3.props = m3, a3.state || (a3.state = {}), a3.context = x2, a3.__n = t3, p2 = a3.__d = true, a3.__h = [], a3._sb = []), null == a3.__s && (a3.__s = a3.state), null != I2.getDerivedStateFromProps && (a3.__s == a3.state && (a3.__s = h({}, a3.__s)), h(a3.__s, I2.getDerivedStateFromProps(m3, a3.__s))), y2 = a3.props, d3 = a3.state, a3.__v = u3, p2)
            ...
            null != a3.componentWillUpdate && a3.componentWillUpdate(m3, a3.__s, x2), null != a3.componentDidUpdate && a3.__h.push(function() {
              a3.componentDidUpdate(y2, d3, _);
            });
          }
          if (a3.context = x2, a3.props = m3, a3.__P = n2, S = l.__r, $2 = 0, "prototype" in I2 && I2.prototype.render) {
            for (a3.state = a3.__s, a3.__d = false, S && S(u3), s2 = a3.render(a3.props, a3.state, a3.context), A2 = 0; A2 < a3._sb.length; A2++)
              a3.__h.push(a3._sb[A2]);
            a3._sb = [];
          } else
            do {
              a3.__d = false, S && S(u3), s2 = a3.render(a3.props, a3.state, a3.context), a3.state = a3.__s;
            } while (a3.__d && ++$2 < 25);
          a3.state = a3.__s, null != a3.getChildContext && (t3 = h(h({}, t3), a3.getChildContext())), p2 || null == a3.getSnapshotBeforeUpdate || (_ = a3.getSnapshotBeforeUpdate(y2, d3)), P(n2, v(H2 = null != s2 && s2.type === k && null == s2.key ? s2.props.children : s2) ? H2 : [H2], u3, i3, t3, o3, r3, f3, e3, c3), a3.base = u3.__e, u3.__h = null, a3.__h.length && f3.push(a3), g3 && (a3.__E = a3.__ = null), a3.__e = false;
        } else
  ...
  function N(l3, u3, i3, t3, o3, r3, f3, e3) {
    var s2, a3, h2, y2 = i3.props, d3 = u3.props, _ = u3.type, k3 = 0;
    if ("svg" === _ && (o3 = true), null != r3) {
      for (; k3 < r3.length; k3++)
        if ((s2 = r3[k3]) && "setAttribute" in s2 == !!_ && (_ ? s2.localName === _ : 3 === s2.nodeType)) {
          l3 = s2, r3[k3] = null;
          break;
        }
    }
    if (null == l3) {
      ...
      l3 = o3 ? document.createElementNS("http://www.w3.org/2000/svg", _) : document.createElement(_, d3.is && d3), r3 = null, e3 = false;
    }
    if (null === _)
      y2 === d3 || e3 && l3.data === d3 || (l3.data = d3);
    else {
      if (r3 = r3 && n.call(l3.childNodes), a3 = (y2 = i3.props || c).dangerouslySetInnerHTML, h2 = d3.dangerouslySetInnerHTML, !e3) {
        if (null != r3)
      ...
      if (H(l3, d3, y2, o3, e3), h2)
        u3.__k = [];
      else if (P(l3, v(k3 = u3.props.children) ? k3 : [k3], u3, i3, t3, o3 && "foreignObject" !== _, r3, f3, r3 ? r3[0] : i3.__k && g(i3, 0), e3), null != r3)
        for (k3 = r3.length; k3--; )
          null != r3[k3] && p(r3[k3]);
      e3 || ("value" in d3 && void 0 !== (k3 = d3.value) && (k3 !== l3.value || "progress" === _ && !k3 || "option" === _ && k3 !== y2.value) && T(l3, "value", k3, y2.value, false), "checked" in d3 && void 0 !== (k3 = d3.checked) && k3 !== l3.checked && T(l3, "checked", k3, y2.checked, false));
    }
    return l3;
  }
  function O(n2, u3, i3) {
...
`;
  ...
  function Plugin() {
    ...
    return /* @__PURE__ */ y(Container, { style: containerStyle, space: "medium" }, /* @__PURE__ */ y(Button, { fullWidth: true, onClick: () => handleButtonClick() }, "Update Storybook"));
  }
  var ui_default;
  var init_ui = __esm({
    "src/ui.tsx"() {
